...
function draw() {
  ...
  box6.display("indigo", "purple");
  box7.display("indigo", "purple");
  box8.display("indigo", "purple");
  box9.display("indigo", "purple");
